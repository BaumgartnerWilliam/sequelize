...
Query.prototype.run = function (sql, parameters) {
  ...
  var promise = new Utils.Promise(function (resolve, reject) {
    // QUERY SUPPORT
    self.connection.config.source = self.sql;
    var requestFunc = self.connection.lib.func('sql',self.connection.config);
    var request = requestFunc(null, function (err,result) {
