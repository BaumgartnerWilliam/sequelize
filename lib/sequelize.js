...
var Sequelize = function (database, username, password, options) {
  ...
  switch (this.getDialect()) {
    ...
    case 'sqlite':
      ...
      break;
    case 'mssqlEdge':
      Dialect = require('./dialects/mssqlEdge');
      break;
    default:
      throw new Error('The dialect ' + this.getDialect() + ' is not supported. Supported dialects: mariadb, mssql, mssqlEdge, mysql, postgres, and sqlite.');
  }
